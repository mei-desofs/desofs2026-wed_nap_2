...
class GameFileTest {
    ...
    void create_storesFilenameExactly() {
        GameFile file = new GameFile("cover.jpg", "/covers/cover.jpg", FileType.COVER, LocalDateTime.now());
        assertThat(file.getFilename()).isEqualTo("cover.jpg");
    }

    @Test
    void create_storesPathExactly() {
        GameFile file = new GameFile("s.png", "/screenshots/s.png", FileType.SCREENSHOT, LocalDateTime.now());
    ...
    void create_storesUploadedAtExactly() {
        ...
        GameFile file = new GameFile("img.png", "/img.png", FileType.IMAGE, timestamp);
    ...
    void create_allFileTypes_storedCorrectly(FileType type) {
        GameFile file = new GameFile("file", "/path", type, LocalDateTime.now());
        assertThat(file.getFileType()).isEqualTo(type);
    }

    @Test
    void create_withImageType_hasCorrectType() {
        GameFile file = new GameFile("img.png", "/img.png", FileType.IMAGE, LocalDateTime.now());
        assertThat(file.getFileType()).isEqualTo(FileType.IMAGE);
    }

    @Test
    void create_withScreenshotType_hasCorrectType() {
        GameFile file = new GameFile("shot.png", "/shot.png", FileType.SCREENSHOT, LocalDateTime.now());
        assertThat(file.getFileType()).isEqualTo(FileType.SCREENSHOT);
    }

    @Test
    void create_withCoverType_hasCorrectType() {
        GameFile file = new GameFile("cover.jpg", "/cover.jpg", FileType.COVER, LocalDateTime.now());
    ...
    void create_absolutePath_storedVerbatim() {
        ...
        GameFile file = new GameFile("img.png", path, FileType.IMAGE, LocalDateTime.now());
    ...
    void create_relativePathWithSubdirectories_storedVerbatim() {
        ...
        GameFile file = new GameFile("cover.jpg", path, FileType.COVER, LocalDateTime.now());
        assertThat(file.getPath()).isEqualTo(path);
    }
    ...
    void twoFiles_withDifferentTypes_areDistinct() {
        ...
        GameFile image = new GameFile("img.png", "/img.png", FileType.IMAGE, now);
        GameFile cover = new GameFile("img.png", "/img.png", FileType.COVER, now);
