...
| **Description**  | Buyers must be able to add a game to a non-finished order. |
| **Actors**       | Buyer                                                      |
...
| ---------------- | --------------------------------------------------------------- |
| **ID**           | RF-16                                                           |
| **Name**         | Remove Game from Order                                          |
| **Description**  | Buyers must be able to remove a game from a non-finished order. |   
| **Actors**       | Buyer                                                           |
| **Restrictions** | Order must be associated to user and in pending state           |
| **Verification** | Validate order cancellation                                     |
| **Priority**     | High                                                            |
...
| **ID**           | RF-18                                                 |
| **Name**         | Finish Order                                          |
| **Description**  | Buyers must be able to finish an an order.            |
| **Actors**       | Buyer                                                 |
| **Restrictions** | Order must be associated to user and in pending state |
| **Verification** | Validate order cancellation                           |
| **Priority**     | Essencial                                             |
...
| ---------------- |----------------------------------------------------------------------------------------|
| **ID**           | RF-21                                                                                  |
| **Name**         | Activate Game Key Upon Order Completion                                                |
| **Description**  | The system must allow the user to activate a purchased game key upon order completion. |
| **Actors**       | System                                                                                 |
...
| ---------------- |-------------------------------------------------------------------------------------------|
| **ID**           | RF-22                                                                                     |
| **Name**         | Download Activation Key Card                                                              |
| **Description**  | The system must allow the user to download the activation key card upon order completion. |
| **Actors**       | System                                                                                    |
| **Restrictions** | Order must be completed and invoice generated                                             |
| **Verification** | Validate activation key                                                                   |
| **Priority**     | Essential                                                                                 |
...
| **Actors**       | Buyer                                                     |
| **Restrictions** | User must be authenticated                                |
| **Verification** | Validate invoice to download                              |
| **Priority**     | High                                                      |
| **State**        | Approved                                                  |
...
| ---------------- | ---------------------------------------------------------- |
| **ID**           | RF-26                                                      |
| **Name**         | Download Game Key Card                                     |
| **Description**  | Buyers must be able to download the key card for an order. |
| **Actors**       | Buyer                                                      |
| **Restrictions** | User must be authenticated                                 |
| **Verification** | Validate key card to download                              |
| **Priority**     | High                                                       |
| **State**        | Approved                                                   |
...
| **Actors**       | System                                                                            |
| **Restrictions** | None                                                                              |
| **Verification** | Validate login failures and anauthorized access attempts                          |
| **Priority**     | High                                                                              |
| **State**        | Approved                                                                          |
...
| **Actors**       | System                                                                                                        |
| **Restrictions** | Secrets must not be hard-coded or written in plaintext to access logs                                         |
| **Verification** | Validate that API keys are injected securely and masked in logging output                                     |
| **Priority**     | Essencial                                                                                                     |
| **State**        | Approved                                                                                                      |
...
| **Actors**       | System                                                                     |
| **Restrictions** | Client must not receive in-depth error information                         |
| **Verification** | Validate that error responses do not reveal system internals or user data. |
| **Priority**     | High                                                                       |
| **State**        | Approved                                                                   |
...
| **Actors**       | System                                                                                 |
| **Restrictions** | Access must be restricted to authorized roles only                                     |
| **Verification** | Validate authorization and access to data                                              |
| **Priority**     | High                                                                                   |
| **State**        | Approved                                                                               |
...
| **Actors**       | System                                                                         |
| **Restrictions** | No operation may rely solely on client-provided identifiers                    |
| **Verification** | Validate authorization checks                                                  |
| **Priority**     | Essential                                                                      |
| **State**        | Approved                                                                       |
...
| **Actors**       | System                                                          |
| **Restrictions** | Limits must be configurable                                     |
| **Verification** | Validate rate limiting behavior under load and stress scenarios |
| **Priority**     | High                                                            |
| **State**        | Approved                                                        |
...
| **Actors**       | System                                                                                        |
| **Restrictions** | Direct static-file access must not be allowed                                                 |
| **Verification** | Validate that a file cannot be accessed or downloaded without proper authorization            |
| **Priority**     | High                                                                                          |
| **State**        | Approved                                                                                      |
...
| **Actors**       | System                                                                                            |
| **Restrictions** | Client-provided filenames and paths must not be used directly in storage or retrieval operations. |
| **Verification** | Validate canonical path checks and rejection of traversal patterns such as ../ sequences.         |
| **Priority**     | Medium                                                                                            |
| **State**        | Approved                                                                                          |
